<?php
	...
	*/
	...
	$sql[80] = "INSERT INTO ".$db['prefix']."settings ( `search_engines` ) VALUES ( 'Googlebot/, Baiduspider, bingbot/, MJ12bot/, Exabot, ia_archiver, msnbot/, Yahoo! Slurp, SEO search Crawler/, crawleradmin.t-info@telekom.de' );";
