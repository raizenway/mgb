<?php
	...
	*/
	...
	$sql[2] = "CREATE TABLE IF NOT EXISTS ".$db_prefix."settings (
		...
		`ayah_pub_key` VARCHAR(255) NOT NULL,
		`ayah_score_key` VARCHAR(255) NOT NULL,
	...
	$sql[3] = "INSERT INTO ".$db_prefix."settings (
		...
		'".$_SERVER['SERVER_NAME']."',
		'1',
		'Googlebot/, Baiduspider, bingbot/, MJ12bot/, Exabot, ia_archiver, msnbot/, Yahoo! Slurp, SEO search Crawler/, crawleradmin.t-info@telekom.de',
		'1',
		'30',
		'1',
		'5',
	...
	$link = mysqli_connect($db_hostname, $db_username, $db_password, $db_dbname) or die ("(mysql.php, line 649) Error: ".mysqli_error($link));
