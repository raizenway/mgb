<?php
	...
	*/
	...
	// SYSTEM LOG TYPES
	$lang['sys_log_type'][1001] = "{ENTRY_USER} hat sich in der Administration angemeldet.";
	$lang['sys_log_type'][1002] = "{ENTRY_USER} hat sich korrekt von der Administration abgemeldet.";
	$lang['sys_log_type'][1003] = "{ENTRY_USER} hat ''Allgemein'' bearbeitet.";
	$lang['sys_log_type'][1004] = "{ENTRY_USER} hat ''Aussehen'' bearbeitet.";
	$lang['sys_log_type'][1005] = "{ENTRY_USER} hat ''Formularfelder'' bearbeitet.";
	$lang['sys_log_type'][1006] = "{ENTRY_USER} hat ''Sicherheit & Anti-Spam'' bearbeitet.";
	$lang['sys_log_type'][1007] = "{ENTRY_USER} hat ''BBCodes'' bearbeitet.";
	$lang['sys_log_type'][1008] = "{ENTRY_USER} hat ''Emoticons'' bearbeitet.";
	$lang['sys_log_type'][1009] = "{ENTRY_USER} hat ''Gravatar'' bearbeitet.";
	$lang['sys_log_type'][1010] = "{ENTRY_USER} hat ''E-Mails'' bearbeitet.";
	$lang['sys_log_type'][1011] = "{ENTRY_USER} hat eine Datenbanksicherung erstellt.";
	$lang['sys_log_type'][1012] = "{ENTRY_USER} hat eine Datenbanksicherung gel&ouml;scht.";
	$lang['sys_log_type'][1013] = "{ENTRY_USER} hat einen oder mehrere Eintr&auml;ge freigeschaltet.";
	$lang['sys_log_type'][1014] = "{ENTRY_USER} hat einen oder mehrere Eintr&auml;ge deaktiviert.";
	$lang['sys_log_type'][1015] = "{ENTRY_USER} hat einen oder mehrere Eintr&auml;ge gel&ouml;scht.";
	$lang['sys_log_type'][1016] = "{ENTRY_USER} hat einen oder mehrere Eintr&auml;ge editiert.";
	$lang['sys_log_type'][1017] = "{ENTRY_USER} hat die Smilies bearbeitet.";
	$lang['sys_log_type'][1018] = "{ENTRY_USER} hat einen neuen Benutzer ({ENTRY_USER_NEW}) angelegt.";
	$lang['sys_log_type'][1019] = "{ENTRY_USER} hat einen Benutzer ({ENTRY_USER_EDIT}) bearbeitet.";
	$lang['sys_log_type'][1020] = "{ENTRY_USER} hat einen Benutzer ({ENTRY_USER_EDIT}) gel&ouml;scht.";
	$lang['sys_log_type'][1021] = "{ENTRY_USER} hat die IP-Liste bearbeitet.";
	$lang['sys_log_type'][1022] = "{ENTRY_USER} hat die E-Mail-Liste bearbeitet.";
	$lang['sys_log_type'][1023] = "{ENTRY_USER} hat die Domain-Liste bearbeitet.";
	$lang['sys_log_type'][1024] = "{ENTRY_USER} hat das Spam-Protokoll verwaltet.";
	$lang['sys_log_type'][1025] = "F&uuml;r den Benutzer <b>{ENTRY_USER}</b> wurde ein falsches Passwort eingegeben.";
	$lang['sys_log_type'][1026] = "Es wurde eine Info-Mail an <b>{ENTRY_NAME}</b> geschickt.";
	$lang['sys_log_type'][1027] = "Ein neues Passwort f&uuml;r <b>{ENTRY_USER}</b> wurde angefordert.";
	$lang['sys_log_type'][1028] = "{ENTRY_USER} hat erfolgreich ein neues Passwort zugeschickt bekommen.";
	$lang['sys_log_type'][1029] = "Es wurde ein neues Passwort f&uuml;r eine ung&uuml;ltige E-Mail von {ENTRY_IP} angefordert.";
	$lang['sys_log_type'][1030] = "{ENTRY_USER} hat eine Datenbanksicherung wiederhergestellt.";
	$lang['sys_log_type'][2001] = "index.php: der Cache wurde neu erstellt bzw. gel&ouml;scht.";
	$lang['sys_log_type'][2002] = "index.php: Die IP {ENTRY_IP} wurde automatisch von der Bannliste gel&ouml;scht.";
	$lang['sys_log_type'][3001] = "newentry.php: Die IP {ENTRY_IP} wurde automatisch auf die Bannliste gesetzt.";
	$lang['sys_log_type'][3002] = "newentry.php: Die IP {ENTRY_IP} wurde automatisch von der Bannliste gel&ouml;scht.";
	$lang['sys_log_type'][3003] = "newentry.php: Ein direkter Zugriff ohne Referer von der IP {ENTRY_IP} wurde geblockt.";
	$lang['sys_log_type'][3004] = "newentry.php: Die IP {ENTRY_IP} wurde f&uuml;r zu schnelles Tippen abgewiesen.";
	$lang['sys_log_type'][3005] = "newentry.php: Das Captcha wurde von der IP {ENTRY_IP} falsch eingegeben.";
	$lang['sys_log_type'][3006] = "Es wurde eine Info-Mail an <b>{ENTRY_NAME}</b> geschickt.";
	$lang['sys_log_type'][4001] = "Eine E-Mail wurde &uuml;ber die <b>email.php</b> verschickt.<br><br>Name: {ENTRY_NAME}<br>E-Mail: {ENTRY_EMAIL}<br>Text: {ENTRY_TEXT}<br>IP: {ENTRY_IP}";
	$lang['sys_log_type'][4002] = "email.php: Die IP <b>{ENTRY_IP}</b> wurde automatisch auf die Bannliste gesetzt.";
	$lang['sys_log_type'][4003] = "email.php: Die IP <b>{ENTRY_IP}</b> wurde automatisch von der Bannliste gel&ouml;scht.";
	$lang['sys_log_type'][4004] = "email.php: Das Captcha wurde von der IP <b>{ENTRY_IP}</b> falsch eingegeben.";
	...
	$lang['updated_domains'] = "{COUNTER} Domains wurden in {TIME} Sekunden aktualisiert.";

	// SPAM_LOG.INC.PHP
	$lang['entries_uploaded'] = "{COUNTER} Eintr&auml;ge wurden in {TIME} Sekunden &uuml;bermittelt.";
	$lang['entries_sneaked'] = "{COUNTER} Eintr&auml;ge wurden in {TIME} Sekunden &uuml;bermittelt.";
	$lang['shortened'] = "&nbsp;[...]";
	$lang['compared_ips'] = "Daf&uuml;r wurden {COUNTER} IPs zum Vergleich herangezogen.";
	$lang['compared_emails'] = "Daf&uuml;r wurden {COUNTER} E-Mails zum Vergleich herangezogen.";
	$lang['compared_domains'] = "Daf&uuml;r wurden {COUNTER} Domains zum Vergleich herangezogen.";
